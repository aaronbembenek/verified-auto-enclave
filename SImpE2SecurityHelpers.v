...
Section Value_Preservation.
  Lemma simpe2_value_type_preservation : forall md G d e bt sl r m v,
...
Section Typing_Helpers.
  ...
  Proof.
    ...
    pose (simpe2_exp_complete md d e merger mergem (Vlambda md c) (Vlambda md c) H0 H0') as tmp.
    destruct tmp; destruct_pairs; auto.
    assert (val_type md G d (Vlambda md c) (Typ (Tlambda Gm p md Gp) q)).
    pose (simpe2_value_type_preservation md G d e
  ...
  Proof.
    ...
    pose (simpe2_exp_complete md d e (merge_reg r r) (merge_mem m m) (Vloc l) (Vloc l)).
    ...
    subst; auto.
    pose (simpe2_value_type_preservation
