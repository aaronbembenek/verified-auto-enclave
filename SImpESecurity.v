...
Require Import SImpE2TypeSystem.
...
Section Secure_Passive.
  ...
  Proof.
    ...
    eapply (protected_typ_no_obs_output r1 m1 true SImpECommon.H md d G hd G r0 m0 tr0); eauto.
    assert (tobs_sec_level L tr' = []).
    rewrite cstep_seq_singleton in H13.
    assert (com_type SImpECommon.H md G d (Cwhile e hd) G).
    eapply Twhile; eauto. unfold sec_level_join; unfold sec_level_le; auto.
    pose (merge_reg r0 r0). pose (merge_mem m0 m0).
    eapply (protected_typ_no_obs_output r2 m2 true SImpECommon.H md d G (Cwhile e hd) G r' m' tr');
  ...
  Proof.
    ...
    - assert (imm_premise c md r m r'0 m'0 tr
      ...
      pose (simpe2_type_preservation G d pc md (Ccall e) r m G'
    ...
    - assert (imm_premise c (Encl enc) r m r'0 m'0 tr
      ...
      pose (simpe2_type_preservation G d pc Normal (Cenclave enc c) r m G'
   ...
   (* SEQ *)
    - assert (imm_premise hd md r0 m0 r m tr
      ...
      pose (simpe2_type_preservation G d pc md (Cseq (hd::tl)) r0 m0 G'
    ...
    -  assert (imm_premise c1 md r m r'0 m'0 tr
       ...
       pose (simpe2_type_preservation G d pc md (Cif e c1 c2) r m G'
    ...
    - assert (imm_premise c md r0 m0 r m tr
      ...
      pose (simpe2_type_preservation G d pc md (Cwhile e c) r0 m0 G'
