...
*******************************************************************************)
Section Soundness.
  Lemma simpe2_exp_sound : forall md d e r m v is_left,
      estep2 md d (e, r, m) v ->
  ...
  Lemma simpe2_sound : forall md d c r m r' m' t is_left,
  ...
  Proof.
    ...
    - apply simpe2_exp_sound with (is_left := is_left) in H0; simpl in *;
    ...
    - rewrite project_app_trace; simpl in *; subst.
      ...
      now apply simpe2_exp_sound with (is_left := is_left) in H0.
    - eapply Cstep_while_f; unfold_cfgs; simpl; eauto.      
      eapply simpe2_exp_sound in H0; eauto.
    - apply simpe2_exp_sound with (is_left := is_left) in H0; simpl in *;
...
Section Completeness.
  Lemma simpe2_exp_complete : forall md d e r m v'1 v'2,
  ...
  Lemma simpe2_complete : forall md d c r m r'1 m'1 t'1 r'2 m'2 t'2,
  ...
  Proof.
    ...
    Local Ltac destruct_exp_complete H :=
      eapply simpe2_exp_complete in H; eauto; destruct H; destruct_conjs.
