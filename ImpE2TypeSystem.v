   ...
   (* Cupdate *)
    ...
    - inversion H4; try discriminate; subst.
      ...
      1-3,5-7,9-11,13-15: destruct p0; [unfold sec_level_le in *; omega | unfold protected];
        split; auto; apply (Loc_Contxt_not_Normal d l bt Common.H rt); unfold protected; auto.
    ...
    - inversion H4; try discriminate; subst.
      ...
      pose (no_assign_cstep_protected_reg_context_constant
              ...
              x Common.H G' G' H27 H12) as c1rconst.
      ...
      pose (no_assign_cstep_protected_reg_context_constant
              ...
              x Common.H G' G' H31 whiletyp) as c2rconst.
      ...
      pose (no_assign_cstep_protected_reg_context_constant
              ...
              x Common.H G' G' H20 H12) as c1rconst.
      ...
      pose (no_assign_cstep_protected_reg_context_constant
              ...
              x Common.H G' G' H24 whiletyp) as c2rconst.
      ...
      pose (no_assign_cstep_protected_reg_context_constant
              ...
              x Common.H G' G' H30 H12) as c1rconst'.
      ...
      pose (no_assign_cstep_protected_reg_context_constant
              ...
              x Common.H G' G' H34 whiletyp) as c2rconst'.
      ...
      pose (no_update_cstep_protected_mem_constant
              md d hd (project_reg r false) (project_mem m false) r0 m0 tr
              l Common.H G' G' H27 H12) as c1rconst.
      ...
      pose (no_update_cstep_protected_mem_constant
              md d (Cwhile e hd) r0 m0 r2 m2 tr'
              l Common.H G' G' H31 whiletyp) as c2rconst.
      ...
      pose (no_update_cstep_protected_mem_constant
              md d hd (project_reg r true) (project_mem m true) r0 m0 tr
              l Common.H G' G' H20 H12) as c1rconst.
      ...
      pose (no_update_cstep_protected_mem_constant
              md d (Cwhile e hd) r0 m0 r1 m1 tr'
              l Common.H G' G' H24 whiletyp) as c2rconst.
